...
public interface ParameterconfigRepository extends JpaRepository<Parameterconfig, Long> {
	...
	@Query(value = "select * from  parameterconfig params where params.clientaffiliateid = :aff  and params.parametertypeid = :paramtype and params.frommonth = :frommonth and params.tomonth = :tomonth order by params.parametertypeid desc", nativeQuery = true)
	...
	@Query(value = "select * from parameterconfig params where params.customerid = :cus  and params.parametertypeid = :paramtype and params.frommonth = :frommonth and params.tomonth = :tomonth order by params.parametertypeid desc", nativeQuery = true)
