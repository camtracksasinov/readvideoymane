...
public class Manualsubnrec {
	...
	public Manualsubnrec() {
	}

	public Manualsubnrec(final Integer customerid, final Integer clientaffiliateid, final Integer transporterid,
